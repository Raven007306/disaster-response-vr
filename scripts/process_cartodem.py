...
def process_cartodem(tif_file_path, show_plots=True, export_unity=True, resolution=1024):
    """
    Process a CartoDEM GeoTIFF file.
    
    Args:
        tif_file_path (str): Path to the GeoTIFF file
        show_plots (bool, optional): Whether to display plots. Defaults to True.
        export_unity (bool, optional): Whether to export for Unity. Defaults to True.
        resolution (int, optional): Resolution for Unity export. Defaults to 1024.
